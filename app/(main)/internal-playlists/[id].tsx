...
const InternalPlaylistScreen = (): JSX.Element => {
	const { t } = useTranslation()
	const { id } = useLocalSearchParams()

	const { isLoading, playlists, setShouldReset, search } = useGetPlaylists(id as string, 'internal')
	/**
	...
	return (
		<View style={styles.container}>
			<Stack.Screen options={{ title: t('pages.internalPlaylist') as string }} />
...
export default InternalPlaylistScreen
